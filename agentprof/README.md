...
| `agentprof census [--days N \| --since RFC3339] [--source DIR \| --source-autodetect] [--skill NAME] [-o out]` | Count skill and tool usage (plus authored-only commands) across Claude Code, Codex, and Antigravity transcript sources. |
