...
| work            | C    | waived: one stub-CLI-tier scenario shipped (evals/work/01-queue-discipline, model-free — RUNNER_CMD="./stub-worker.sh"); full paid Tier A evalset (≥2 scenarios, ≥1 adversarial) pending a later round |                                              |
