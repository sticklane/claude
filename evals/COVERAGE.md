...
| codebase-memory      | A    | ≥2 scenarios, ≥1 adversarial (NN-adv-\*); fixtures cover ambiguous symbols, incomplete/paginated coverage, stale source, and bounded `rg` fallback without a live network dependency                                |                                            |
...
| beads                | B    | deterministic tracker core; model-free queue/status and claim-compliance tests in lieu of a paid run                                                                                                                  | tests/test_status_cutover.sh, tests/test_bd_compliance_hook.sh |
| workboard            | B    | deterministic core; model-free test in lieu of a paid run                                                                                                                                                             | .claude/skills/workboard/test_workboard.py |
| anti-ai-slop-writing | C    | waived: prose-generation constraints with no deterministic core; exercised through drafted output                                                                                                                     |                                            |
| clone-audit          | C    | waived: depends on the external jscpd tool; pending a later round                                                                                                                                                     |                                            |
| design               | C    | waived: pending a later round                                                                                                                                                                                         |                                            |
| doc-coauthoring      | C    | waived: interactive co-authoring flow, not hermetically evalable                                                                                                                                                      |                                            |
| example-corpus       | C    | waived: pending a later round (the capture→approve→append round-trip is the named candidate)                                                                                                                          |                                            |
| factcheck            | C    | waived: non-hermetic network flow, not hermetically evalable                                                                                                                                                          |                                            |
| grounding            | C    | waived: prose-discipline rules with no deterministic core; exercised through drafted output                                                                                                                           |                                            |
| humanizer            | C    | waived: prose-edit pass with no deterministic core; exercised through edited output                                                                                                                                   |                                            |
...
| work                 | C    | waived: one stub-CLI-tier scenario shipped (evals/work/01-queue-discipline, model-free — runner-cmd.txt wires its stub as the default); full paid Tier A evalset (≥2 scenarios, ≥1 adversarial) pending a later round |                                            |
| workflow-author      | C    | waived: pending a later round                                                                                                                                                                                         |                                            |
| writing-user-docs    | C    | waived: pending a later round (Microsoft-MoS review flow; promotion candidate once its checks get a script core)                                                                                                      |                                            |
