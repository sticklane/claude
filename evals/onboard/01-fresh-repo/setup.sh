...
# CLAUDE.md, AGENTS.md, or .claude/). /onboard scouts it, RUNS ./run-tests.sh
# to verify, then writes the AGENTS.md/CLAUDE.md orientation split and a
# .claude/settings.json permission allowlist. assert.sh grades those artifacts
# structurally, not a live rerun.
