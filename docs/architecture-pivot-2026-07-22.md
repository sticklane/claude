...
agent can read the bd queue, the Codebase-Memory index, and the task files. No
...
| A wrapper around the code index                                                                                                   | Obsolete                                                                              | Codebase-Memory is invoked directly through MCP or its launcher; another wrapper adds no capability                                 |
...
| Codebase-Memory                                                                                                  | Code-structure index: architecture, symbols, relationships, and impact | Differentiated; no native equivalent; adoption comes from injection, which the skills own                     |
