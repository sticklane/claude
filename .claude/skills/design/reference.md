...
`.claude/rules/token-discipline.md`, and right-sizing process work stays
behind /idea's "a script, not a spec" gate. Research record and sources:
docs/external-playbooks.md ("Code-vs-LLM ladder").
