...
Tell the user: for multi-session work run `/breakdown specs/<slug>/SPEC.md`;
for single-session work run `/build specs/<slug>/SPEC.md` — in a FRESH
session (`/clear` first). The spec is the handoff artifact; this
