...
Status: pending
Depends on: 01, 02, 03, 04, 05, 06, 07, 08 (global terminal — runs last in the combined multi-spec queue; the orchestrator wires the exact cross-spec dependencies at dispatch), ../../model-agnostic/tasks/04-antigravity-mirrors.md, ../../context-management/tasks/03-tool-call-ceilings.md, ../../beads-integration/tasks/02-beads-backend.md
Budget: 40 turns
