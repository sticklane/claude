...
- [x] `grep -ci 'gameable' .claude/agents/critic.md` → ≥ 1 and
...
.claude/skills/critique/SKILL.md` → ≥ 1 — the verbatim sentence
      ...
      criterion.
      Evidence 2026-07-19: grep -ci critic.md → 2; grep -c critique/SKILL.md → 1.
- [x] `bash evals/lint-ultra-gate.sh` → exit 0
      Evidence 2026-07-19: exit 0 ("OK — all ultra mentions gated in 4 files").
