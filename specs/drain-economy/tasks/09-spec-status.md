...
Touch: bin/spec-status, tests/test_spec_status.sh, tests/fixtures/spec-status, tests/inventory/drain-economy-09.json, specs/toolkit-core-simplification/surface-inventory/drain-economy-09.json
