...
Status: pending
Depends on: ../../review-fixes/tasks/02-drain-state-machine.md, ../../review-fixes/tasks/03-header-contract.md, ../../context-management/tasks/01-claude-md-and-breakdown-note.md
Priority: P1
Budget: 25 turns
...
- .claude/skills/breakdown/SKILL.md (also edited by rf-03, cm-01 — deps serialize)
