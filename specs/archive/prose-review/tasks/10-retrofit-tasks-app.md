# Task 10: retrofit tasks-app orientation docs
...
Touch: ~/tasks-app, specs/prose-review/evidence/retrofit-tasks-app.md

## Goal

Run /prose-review (per its shipped SKILL.md) over ~/tasks-app's orientation
