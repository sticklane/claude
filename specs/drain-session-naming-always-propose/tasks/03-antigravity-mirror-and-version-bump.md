...
- [ ] `grep -c "regardless of the adopted owner lease's" antigravity/.agents/workflows/drain.md` → ≥ 1
...
- [ ] `sed -n '/\*\*Name the run/,/\*\*Startup session sweep/p' antigravity/.agents/workflows/drain.md | grep -c 'gen-1 startup'`
...
- [ ] `grep -c 'Name the run (gen 1, best-effort)' antigravity/.agents/workflows/drain.md`
